...
- Transformer and CNN-hybrid architectures
...
- Alternative splicing and intron retention modeling
- STAR, StringTie, rMATS
- Genomic interval engineering and large-scale annotation workflows

**Interpretation and Infrastructure**
- DeepLIFT / DeepSHAP, TF-MoDISco, MEME / FIMO
- HPC / SLURM orchestration
- Conda environments and reproducible pipeline development
...
- [Engineering & ML](/ml.md) — model architecture, training workflows, and code
- [Publications](/publications.md)
- [Download my CV](/Dearborn_CV_March_2026.pdf)

If you are hiring for roles in computational genomics or ML for biology, I would be glad to connect.
...
- GitHub: [jsdearbo](https://github.com/jsdearbo)
- LinkedIn: [Jake Dearborn](https://www.linkedin.com/in/jake-dearborn-15408652/)